...
[블랙홀 팀짜기 PWA](https://blackhole-teammaker.vercel.app)를 Chrome 또는 Edge에서 연 다음 브라우저 메뉴의 **앱 설치** 또는 **홈 화면에 추가**를 선택합니다. 앱을 온라인에서 한 번 정상 로드하면 필요한 실행 파일이 캐시되어 오프라인에서도 다시 열 수 있습니다.
